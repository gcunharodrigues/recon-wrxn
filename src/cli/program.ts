/**
 * recon-wrxn CLI program builder.
 *
 * Returns the configured commander program WITHOUT parsing, so the
 * identity (name/version) is unit-testable without triggering argv parsing.
 * Name and version are read from package.json — no stale hardcoded strings.
 */
